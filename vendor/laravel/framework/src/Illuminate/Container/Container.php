...
class Container implements ArrayAccess, ContainerContract
{
     ...
     * @description 判断一个类是否已经陪bind 或者已经有假名了
     ...
     * @description 通过回调和闭包中的静态变量来定义一个单例
     ...
     * @description 重新实例化一个对应抽象的对象，并且调用
     * @param  string  $abstract
     * @return void
     */
